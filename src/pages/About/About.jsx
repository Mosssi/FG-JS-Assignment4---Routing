      ...
      <div className={styles.container}>
        <div className={styles.group1}>
          ...
          <p className={styles.text}>
            This is a multi page movie browing aplication built with React. It uses the TMDB API to fetch real-time data, focusing on front-end routing, state management, and component architecture           
          </p>
          
          <h4 className={styles.subTitle}>Site Structure</h4>
           <p className={styles.text}>
            The site includes Home, Genres, Movies, and Details pages, allowing users to easily discover and explore top-rated films.
           </p>
        </div>
